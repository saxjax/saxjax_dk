import { RedBlackNode, RedBlackTree } from './redBlackTree'
...
describe('RedBlackTree', () => {
  ...
  describe('findNode', () => {
    const primaryNode: RedBlackNode<number> = {
      id: 0,
      value: 1,
      right: undefined,
      left: undefined,
    } as RedBlackNode<number>
    const greaterNode: RedBlackNode<number> = {
      id: 2,
      value: 2,
      right: undefined,
      left: undefined,
    } as RedBlackNode<number>
    const lesserNode: RedBlackNode<number> = {
      id: 3,
      value: 0,
      right: undefined,
      left: undefined,
    ...
    const equalNode: RedBlackNode<number> = {
      id: 1,
      value: 1,
      right: undefined,
      left: undefined,
    } as RedBlackNode<number>
    const notInTreeNode: RedBlackNode<number> = {
      id: 4,
      value: 10,
      right: undefined,
      left: undefined,
